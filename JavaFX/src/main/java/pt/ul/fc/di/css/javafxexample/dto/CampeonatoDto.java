...
import pt.ul.fc.di.css.javafxexample.model.Campeonato.EstatisticasCampeonato;
...
public class CampeonatoDto {
    ...
    public CampeonatoDto(Liga liga) {
        ...
        this.completado = liga.isCompletado();
    ...
    public CampeonatoDto(Campeonato campeonato) {
        ...
        this.completado = campeonato.isCompletado();
        
    }

    public CampeonatoDto(long id, String nome, String epoca) {
        this.id = id;
        this.nome = nome;
        this.epoca = epoca;
    }
