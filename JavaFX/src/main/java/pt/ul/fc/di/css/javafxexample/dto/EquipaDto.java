...
import pt.ul.fc.di.css.javafxexample.model.Equipa.EstatisticasEquipa;
import pt.ul.fc.di.css.javafxexample.model.Equipa.Podio;
...
public class EquipaDto {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EquipaDto)) return false;
        EquipaDto that = (EquipaDto) obj;
